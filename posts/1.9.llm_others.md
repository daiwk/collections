...
论文翻译网站：[https://hjfy.top/](https://hjfy.top/)
...
![htps-disambiguate-query](<.gitbook/assets/htps-disambiguate-query (1).png>)

把用户历史的q-d pair对和当前query一起，过短期transformer和长期transformer得到输出$$q^l$$。

![htps-predict-intent](<.gitbook/assets/htps-predict-intent (1).png>)
...
![gnn-personalized-video-search](<.gitbook/assets/gnn-personalized-video-search (1).png>)
