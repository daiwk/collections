...
[GPT-Live](https://openai.com/zh-Hans-CN/index/introducing-gpt-live/)从音频路径中移除了turn detector。它的语音模型采用全双工模式(full-duplex)，意味着它可以同时聆听和说话。当需要更深入的推理或使用工具时，GPT-Live还可以参考我们前沿的模型如GPT-5.5，而不会中断对话流程。
