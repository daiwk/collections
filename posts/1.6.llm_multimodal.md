...
![stable-diffusion](.gitbook/assets/stable-diffusion.png)
...
![tarsier](.gitbook/assets/tarsier.png)
...
![bsq-vq-lfq](.gitbook/assets/bsq-vq-lfq.png)

![bsq-fsq-lfq](.gitbook/assets/bsq-fsq-lfq.png)
...
![InstantID](.gitbook/assets/InstantID.png)
...
![vivit](.gitbook/assets/vivit.png)

先分patch，再分别过时间的transformer（temporal transformer）和空间的transformer（spatial transformer）

![tubelet-embedding](.gitbook/assets/tubelet-embedding.png)
...
![spacetime-patches](.gitbook/assets/spacetime-patches.png)
...
![latte](.gitbook/assets/latte.png)
...
![stdit](.gitbook/assets/stdit.png)
...
![pixart-alpha-temperal](.gitbook/assets/pixart-alpha-temperal.png)
...
![llava-caption](.gitbook/assets/llava-caption.png)
...
![mini-gemini](.gitbook/assets/mini-gemini.png)
...
![](.gitbook/assets/thinkdiff-lvlm+clip.png)
...
![](.gitbook/assets/cambrian-s-1.png)
