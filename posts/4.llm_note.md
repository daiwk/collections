...
![](../assets/reinforce-one-step-reward.png)
...
[MIT系列视频](https://www.bilibili.com/video/BV1rH4y1N7BW/?spm_id_from=333.788.videopod.episodes&vd_source=1ae2f94a63a5ab75ddbbb426fa107515&p=3)
...
矩阵$$B$$有好几列，取其中一列出来，这列的每个元素作为权重，去和$$A$$里每一列相乘，再相加，就得到$$C$$的这一列（就是对A中所有列的线性组合）
...
矩阵$$A$$有好几行，取其中一行出来，这行的每个元素作为权重，去和$$B$$里每一行相乘，再相加，就得到$$C$$的这一行（就是对B中所有行的线性组合）
...
这个矩阵没有逆，因为这两列是平行的，不论如何线性组合都是平行于$$\begin{bmatrix}
1\\
3\\
