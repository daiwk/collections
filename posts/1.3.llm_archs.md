...
![mixed-precision-training](.gitbook/assets/mixed-precision-training.png)
...
![fp16-bf16](.gitbook/assets/fp16-bf16.png)
...
![gpipe](.gitbook/assets/gpipe.png)
...
![tensor parallelism](.gitbook/assets/tensor-parallelism.png)
...
![megatron-transformer](.gitbook/assets/megatron-transformer.png)
...
![megatron-transformer-1layer](.gitbook/assets/megatron-transformer-1layer.png)
...
![clossal-ai-efficiency](.gitbook/assets/clossal-ai-efficiency.png)
...
![tensor-parallel](.gitbook/assets/tensor-parallel.png)

SP：

![sequence-parallel](.gitbook/assets/sequence-parallel.png)
...
![megatron-results](.gitbook/assets/megatron-results.png)
...
![TorchDynamo](.gitbook/assets/TorchDynamo.png)
...
![doremi](.gitbook/assets/doremi.png)
...
![dataset-decomposition](.gitbook/assets/dataset-decomposition.png)
...
![rho-1](.gitbook/assets/rho-1.png)

把语料中的无用token从loss里删了

![slm](.gitbook/assets/slm.png)
...
![effective\_transformer](.gitbook/assets/effective_transformer.png)
...
![minference](.gitbook/assets/minference.png)
...
![](.gitbook/assets/mega-scale-infer.png)
...
![](.gitbook/assets/timeline-speculative-decoding.png)
