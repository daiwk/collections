...
![mixed-precision-training](<.gitbook/assets/mixed-precision-training (1).png>)
...
![fp16-bf16](<.gitbook/assets/fp16-bf16 (1).png>)
...
![gpipe](<.gitbook/assets/gpipe (1).png>)
...
![tensor parallelism](<.gitbook/assets/tensor-parallelism (1).png>)
...
* **行并行（row parallelism）**：两个矩阵都横着劈成两半，即$$A=\left[\begin{array}{l}A_1 \\A_2\end{array}\right],B=\left[\begin{array}{l}B_1 \\B_2\end{array}\right]$$。从2推广到k，其实就是**split-k算法**，把两个矩阵都分成k个小块，两两相乘后，最后reduce\_sum一下。因为每个线程计算的矩阵更小了，开销小，可以通过加大线程数来提升并行效率。
  * `[m, k/2], [k/2, n] -> [m, n]`
...
![megatron-transformer](<.gitbook/assets/megatron-transformer (1).png>)
...
![megatron-transformer-1layer](<.gitbook/assets/megatron-transformer-1layer (1).png>)
...
![clossal-ai-efficiency](<.gitbook/assets/clossal-ai-efficiency (1).png>)
...
![zero](<.gitbook/assets/zero (1).png>)
...
![tensor-parallel](<.gitbook/assets/tensor-parallel (1).png>)

SP：

![sequence-parallel](<.gitbook/assets/sequence-parallel (1).png>)
...
![megatron-results](<.gitbook/assets/megatron-results (1).png>)
...
![TorchDynamo](<.gitbook/assets/TorchDynamo (1).png>)
...
![doremi](<.gitbook/assets/doremi (1).png>)
...
![dataset-decomposition](<.gitbook/assets/dataset-decomposition (1).png>)
...
![rho-1](<.gitbook/assets/rho-1 (1).png>)

把语料中的无用token从loss里删了

![slm](<.gitbook/assets/slm (1).png>)
...
[https://zhuanlan.zhihu.com/p/701623664?utm\_psn=1784500156948938753](https://zhuanlan.zhihu.com/p/701623664?utm_psn=1784500156948938753)
...
这个回答分析得不错 [https://www.zhihu.com/question/524596983/answer/2420225275](https://www.zhihu.com/question/524596983/answer/2420225275)
...
[https://docs.vllm.ai/en/stable/features/?h=feature#feature-x-feature](https://docs.vllm.ai/en/stable/features/?h=feature#feature-x-feature)
...
参考[https://docs.vllm.ai/en/latest/features/compatibility\_matrix.html](https://docs.vllm.ai/en/latest/features/compatibility_matrix.html)看所有特性的兼容性，还有[https://docs.vllm.ai/en/latest/performance/optimization.html](https://docs.vllm.ai/en/latest/performance/optimization.html)
...
![effective\_transformer](<.gitbook/assets/effective_transformer (1).png>)

源自[https://github.com/NVIDIA/FasterTransformer/blob/main/docs/bert\_guide.md](https://github.com/NVIDIA/FasterTransformer/blob/main/docs/bert_guide.md)，思想其实是[https://github.com/bytedance/effective\_transformer](https://github.com/bytedance/effective_transformer)提出的

直接有这么个脚本：

[https://github.com/NVIDIA/TensorRT-LLM/blob/main/examples/recurrentgemma/convert\_checkpoint.py](https://github.com/NVIDIA/TensorRT-LLM/blob/main/examples/recurrentgemma/convert_checkpoint.py)

[https://github.com/daiwk/TensorRT-LLM/blob/main/tensorrt\_llm/models/recurrentgemma/model.py](https://github.com/daiwk/TensorRT-LLM/blob/main/tensorrt_llm/models/recurrentgemma/model.py)

关于plugin：

* 自己加plugins：[https://github.com/NVIDIA/TensorRT-LLM/tree/main/examples/openai\_triton](https://github.com/NVIDIA/TensorRT-LLM/tree/main/examples/openai_triton)
* 已有plugins：[https://github.com/NVIDIA/TensorRT-LLM/tree/main/cpp/tensorrt\_llm/plugins](https://github.com/NVIDIA/TensorRT-LLM/tree/main/cpp/tensorrt_llm/plugins)
...
[https://github.com/huggingface/text-generation-inference/blob/main/server/text\_generation\_server/models/causal\_lm.py](https://github.com/huggingface/text-generation-inference/blob/main/server/text_generation_server/models/causal_lm.py)

[https://github.com/huggingface/text-generation-inference/blob/main/server/text\_generation\_server/models/seq2seq\_lm.py](https://github.com/huggingface/text-generation-inference/blob/main/server/text_generation_server/models/seq2seq_lm.py)

[https://github.com/huggingface/text-generation-inference/blob/main/server/text\_generation\_server/models/mamba.py](https://github.com/huggingface/text-generation-inference/blob/main/server/text_generation_server/models/mamba.py)
...
![minference](<.gitbook/assets/minference (1).png>)
...
[https://github.com/Multiverse4FM/Multiverse](https://github.com/Multiverse4FM/Multiverse)
...
![](<.gitbook/assets/mega-scale-infer (1).png>)
...
![](<.gitbook/assets/timeline-speculative-decoding (1).png>)
...
![](<.gitbook/assets/speculative-decoding (1).png>)
...
![](<.gitbook/assets/speculative-decoding-verify (1).png>)
...
[https://github.com/mirage-project/mirage/tree/mpk](https://github.com/mirage-project/mirage/tree/mpk)
