...
中科大LDS实验室的tutorial：[XadC3O-large-language-models-for-recommendation-tutorial-slides.pdf](../assets/XadC3O-large-language-models-for-recommendation-tutorial-slides.pdf)
...
![llm-rec-where](.gitbook/assets/llm-rec-where.png)

![llm-rec-how](.gitbook/assets/llm-rec-how.png)
...
![s3-rec](.gitbook/assets/s3-rec.png)

这些方法都是学习item的向量，然后用MIPS去ANN，而TIGER(Transformer Index for GEnerative Recommenders)则是生成式地直接预测item的语义id

![tiger](.gitbook/assets/tiger.png)

![tiger-quant](.gitbook/assets/tiger-quant.png)

![tiger-personalized](.gitbook/assets/tiger-personalized.jpg)

rq-vae的介绍：

![rq-vae](.gitbook/assets/rq-vae.png)
...
![](.gitbook/assets/sid-has-seq.png)
...
![nce-metric](.gitbook/assets/nce-metric.png)

可以发现，对于一个预训练好的模型来说，随着时间的变化，NCE的变化是很剧烈的，即数据分布是会漂移的，并不像nlp/cv一样有ground truth，所以传统推荐模型其实很难达到比较好的scaling能力。

![nce-distribution-drift](.gitbook/assets/nce-distribution-drift.png)
...
![hstu-dlrm-vs-gr](.gitbook/assets/hstu-dlrm-vs-gr.png)
...
![hstu-arch](.gitbook/assets/hstu-arch.png)
...
![gated-attention-unit](.gitbook/assets/gated-attention-unit.png)
...
![](.gitbook/assets/m-falcon-mask.png)
...
![hstu-scaling-law](.gitbook/assets/hstu-scaling-law.png)
...
![](.gitbook/assets/unify-sid-id.png)

![](.gitbook/assets/unify-sid-id2.png)
...
![](.gitbook/assets/prefix-ngram.png)
...
![](.gitbook/assets/vista-1.png)

![](.gitbook/assets/vista-2.png)
...
![](.gitbook/assets/mtgr-tradition.png)
...
![](.gitbook/assets/next-interest-flow.png)
...
![](.gitbook/assets/pinrec-demo.png)
...
![](.gitbook/assets/pinfm-serving.png)
...
![](.gitbook/assets/genrank-mask.png)
...
![](.gitbook/assets/cobra-vs-tiger.png)

和tiger很像，主要区别是除了原来rq的code，还加了个dense emb进去

![](.gitbook/assets/cobra.png) rq部分freeze，dense是拿item的明文特征过一个bert得到的cls emb，bert是训练的

decode出来有两个东西，rq的code和dense

![](.gitbook/assets/cobra-search.png)
...
![](.gitbook/assets/gpr-training.png)
...
![](.gitbook/assets/onepiece-frame.png)

![](.gitbook/assets/onepiece-context-engineering.png)

![](.gitbook/assets/onepiece-reasoning-mtl.png)
...
![](.gitbook/assets/argus-pretrain.png)
...
![](.gitbook/assets/argus-finetune.png)
...
![](.gitbook/assets/novelty-llm.png)
...
![](.gitbook/assets/serendipitous-prompts.png)
...
![](.gitbook/assets/plum-cpt-data.png)
...
![](.gitbook/assets/coea-prompts.png)
...
![](.gitbook/assets/urm-item-emb.png)
...
![](.gitbook/assets/recgpt-user-mining.png)
...
![](.gitbook/assets/recgpt-human-llm.png)

![](.gitbook/assets/recgpt-item-tag-pred.png)
...
![](.gitbook/assets/recgpt-item-retrieval.png)
...
![](.gitbook/assets/recgpt-explanation.png)
...
![](.gitbook/assets/choirrec-frame.png)
...
![](.gitbook/assets/choirrec-stage2.png)
...
![](.gitbook/assets/choirrec-stage3.png)
...
![rec2llm-llm2rec](.gitbook/assets/rec2llm-llm2rec.png)

快手商业化把llm用到推荐的思路变化：

![](.gitbook/assets/learn-roadmap.png)

本文提出了LEARN(Llm-driven knowlEdge Adaptive RecommeNdation)，实现了LLM-to-Rec，让LLM作为content extractor，推荐任务是训练目标。

![learn-cex-pal](.gitbook/assets/learn-cex-pal.png)
...
![learn](.gitbook/assets/learn.png)
...
![](.gitbook/assets/pinnerformer-loss.png)
...
![](.gitbook/assets/staytime-analysis.jpeg)
...
![](.gitbook/assets/r4ec-dataset.png)
...
![](.gitbook/assets/das-kuaishou.png)
...
![](.gitbook/assets/align3gr.png)

![](.gitbook/assets/align3gr-arch.png)

![](.gitbook/assets/behavior-modeling-level-align.png)
...
![](.gitbook/assets/kar-prompts.png)
...
![notellm](.gitbook/assets/notellm.png)
...
![ILM-tasks](.gitbook/assets/ILM-tasks.png)
...
![](.gitbook/assets/2-stage-blip-2.png)

引入了Q-former

![ILM](.gitbook/assets/ILM.png)
...
![](.gitbook/assets/embsum-summary.png)
...
![](.gitbook/assets/recoworld-modeling.png)

![](.gitbook/assets/recoworld-mindset.png)
...
![](.gitbook/assets/recoworld-agentic-recsys.png)
...
![](.gitbook/assets/text-features.png)

整体的框架如下：

![](.gitbook/assets/llm-cf-online-offline.png)
...
![](.gitbook/assets/llm-cf-total.png)
...
![dllm2rec](.gitbook/assets/dllm2rec.png)
...
![](.gitbook/assets/great-finetune.png)
...
![](.gitbook/assets/great-sample.png)
...
![](.gitbook/assets/llama-e-tasks.png)
...
![](.gitbook/assets/sagcn-graph.png)
...
word版的笔记：[https://github.com/daiwk/collections/blob/master/assets/multi-agents.docx](../assets/multi-agents.docx)
...
![](.gitbook/assets/trans-rec-instruct-tuning.png)
...
![](.gitbook/assets/transrec-generation-grounding.png)
...
![](.gitbook/assets/llama4rec-prompts.png)
...
![](.gitbook/assets/guided-emb.png)

一些相关prompt：

* aspect示例：

![](.gitbook/assets/guided-emb-aspect.png)

* item prompt：

![](.gitbook/assets/guided-emb-item-prompt.png)

* user prompt：

![](.gitbook/assets/guided-emb-user-prompt.png)

* user review示例：

![](.gitbook/assets/guided-emb-user-review.png)

* item示例：

![](.gitbook/assets/guided-emb-item-example.png)

### GMC

[Generative Multi-Target Cross-Domain Recommendation](https://arxiv.org/abs/2507.12871)

![](.gitbook/assets/gmc.png)
...
![](.gitbook/assets/gream-onerecthink.jpg)
...
![](.gitbook/assets/auxiliary-head.png)
...
![](.gitbook/assets/decision-transformer.png)
...
导出了对应的[pdf1](../assets/llm-gen-user-emb.pdf)，[pdf2](../assets/llm-gen-user-emb-64dim.pdf)
...
![gecko](.gitbook/assets/gecko.png)
...
![chatretriever](.gitbook/assets/chatretriever.png)
...
![](.gitbook/assets/unime-text-distill.png)
...
![](.gitbook/assets/qwen3-emb-arch.png)
...
![](.gitbook/assets/qwen3-emb-train.png)
...
![](.gitbook/assets/t5gemma-embgemma.png)
...
![](.gitbook/assets/mtmh-serving-content.png)
...
![](.gitbook/assets/dgenctr.png)

![](.gitbook/assets/dgenctr-model.png)
...
![](.gitbook/assets/store-1epoch.png)
...
![](.gitbook/assets/pinterest-2-stage.png)
...
![](.gitbook/assets/multi-faceted-1.png)

红色部分的item id的emb用的是上面那篇paper的2阶段方法，即下图的结构

![](.gitbook/assets/multi-faceted-2.png)
...
![](.gitbook/assets/multi-faceted-3.png)
