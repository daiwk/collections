...
![](.gitbook/assets/kunlun-pffn.png)
...
![](.gitbook/assets/semi-local-attn.png)

* bf16/fp8的混精度算子融合，同时适配AMD卡（可能能支持异构gpu训练？）

![](.gitbook/assets/fuse-mixed-ultra-hstu.png)
...
![](.gitbook/assets/mtfm.png)

![](.gitbook/assets/mtfm-mask.png)
...
![](.gitbook/assets/grc-idea.png)

![](.gitbook/assets/grc.png)
...
![](.gitbook/assets/onerec-arch.png)

![](.gitbook/assets/onerec.png)

![](.gitbook/assets/onerec-kmeans.png)

![](.gitbook/assets/onerec-deploy.png)
...
![](.gitbook/assets/unipinrec-serving.png)
...
![](.gitbook/assets/s-grec.png)

在GR里加了一个LLM as Judge产出语义reward，加上业务指标的reward一起RL

![](.gitbook/assets/s-grec-frame.png)
...
![](.gitbook/assets/s-grec-advantage.png)
...
![](.gitbook/assets/oneranker-arc.png)

![](.gitbook/assets/oneranker.png)
...
![](.gitbook/assets/climber-pilot.png)
...
![](.gitbook/assets/climber-pilot-serving.png)
...
![](.gitbook/assets/capacity-constrained-rq.png)
...
![](.gitbook/assets/snapchat-sid-gr.png)
...
![](.gitbook/assets/static-algo1.png)

![](.gitbook/assets/static-algo2.png)

### Google的LLM用户画像

[LLM-Based User Personas for Recommendations at Scale](https://arxiv.org/pdf/2606.12198)

![](.gitbook/assets/llm-user-persona.png)

![](.gitbook/assets/llm-user-persona-arch.png)
...
![](.gitbook/assets/tokenminds1.png)

产出2个东西给下游用，一个是encoder输出的emb，一个是decoder输出的sid

![](.gitbook/assets/tokenminds-enc-dec.png)
...
![](.gitbook/assets/tokenminds-multicontext-decoding.png)

为了区分场景，在每个item前面加condition token，例如`<LFV>`(长视频)和`<SFV>`（短视频）

![](.gitbook/assets/tokenminds-decoder-input.png)

![](.gitbook/assets/tokenminds-serving.png)
...
![](.gitbook/assets/llm-ad2ad-gen.png)

![](.gitbook/assets/llm-context-cate-graph.png)
...
*   Step 1：通用用户画像构建
    ...
    * 静态画像：背景信息、人格特质、表达风格、生活场景。基于AlignX（[From 1,000,000 Users to Every User: Scaling Up Personalized Preference for User-level Alignment](https://arxiv.org/pdf/2503.15463)）的数据集，把其中如下图的90维偏好向量和人口属性特征丢给LLM，通过不同prompt产出上述4种静态画像
    ...
    ![](.gitbook/assets/profile-schema.png)

    ![](.gitbook/assets/alignx.jpg)
...
![](.gitbook/assets/sigma-scaling-deploy.png)
...
![](.gitbook/assets/glide-prompt.png)
...
![](.gitbook/assets/neo.png)

![](.gitbook/assets/neo-compare.png)

![](.gitbook/assets/neo-stage.png)
...
![](.gitbook/assets/mavrs-future.png)
...
![](.gitbook/assets/zeroshot-crossdomain-kd.png)
...
![](.gitbook/assets/llatte-query.png)
...
![](.gitbook/assets/monn-hill.png)

![](.gitbook/assets/monn.png)
...
![](.gitbook/assets/onelayer-attn-learning.png)
...
![](.gitbook/assets/3layer-monn.png)
...
![](.gitbook/assets/pre-materialization.png)
...
![](.gitbook/assets/versioned-late-materialization.png)
...
![](.gitbook/assets/rec-distill.png)
...
![](.gitbook/assets/rec-distill-arch.png)
...
![](.gitbook/assets/sira-compare.png)

![](.gitbook/assets/sira.png)
...
![](.gitbook/assets/mixlm1.png)

![](.gitbook/assets/mixlm2.png)
...
![](.gitbook/assets/slm-ranking.png)
...
![](.gitbook/assets/slm-ranking2.png)
...
![](.gitbook/assets/slm-ranking-ablation.png)

还做了loss mask，即一些很sparse的正例很容易被淹没，因此对于每个正例，只保留它所在那些query的样本来做负例，如图

![](.gitbook/assets/slm-ranking-loss-mask.png)
...
![](.gitbook/assets/lightretriever.png)
...
![](.gitbook/assets/lightretriever-dense.png)
...
![](.gitbook/assets/lightretriever-sparse.png)
...
![](.gitbook/assets/self-evolving-recsys.png)
...
![](.gitbook/assets/self-evolving-recsys-prompt.png)

![](.gitbook/assets/self-evolving-recsys-modelsize.png)
...
![](.gitbook/assets/agenticrectune.png)

Reasoning Loop：

actor和critic的prompt：

![](.gitbook/assets/actor-critic-prompt.png)
...
![](.gitbook/assets/gears.png)

![](.gitbook/assets/gears-algo.png)

![](.gitbook/assets/gears-2.png)

### 虾皮的Sortify

[Let the Agent Steer: Closed-Loop Ranking Optimization via Influence Exchange](https://arxiv.org/pdf/2603.27765v1)

![](.gitbook/assets/sortify1.png)

![](.gitbook/assets/sortify2.png)

![](.gitbook/assets/sortify-arch.png)
...
![](.gitbook/assets/sortify-llm.png)
...
![](.gitbook/assets/mfli1.png)

LI（learnable index）就是在训练的时候建好索引，参考当年的tdm

![](.gitbook/assets/mfli.png)
...
![](.gitbook/assets/mfli-rebalancing.png)

![](.gitbook/assets/mfli-index-structure.png)
...
![](.gitbook/assets/meta-adaptive-ranking-model.png)

![](.gitbook/assets/meta-adaptive-ranking-model2.png)
...
![](.gitbook/assets/est-multi-epoch.png)
