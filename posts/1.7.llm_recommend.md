...
加reasoning的综述：[Towards Reasoning-Aware Recommender Systems: A Survey in the LLM Era](https://www.researchgate.net/publication/397223831_Towards_Reasoning-Aware_Recommender_Systems_A_Survey_in_the_LLM_Era)
...
最终serving时加了一路召回，拿用户的K个兴趣分别召回，近线预估，每次输入用户最近10个行为，在冷启item/user上有收益
