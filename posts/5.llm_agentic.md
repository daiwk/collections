...
![](.gitbook/assets/tool_call_code1.jpg)

然后这个东西基于的是openai.BaseModel(transformers里最终也是走到这里)

![](.gitbook/assets/tool_call_code2.jpg)

然后去openai里看

![](.gitbook/assets/tool_call_code3.jpg)
...
![self-generated-cot-template](.gitbook/assets/self-generated-cot-template.png)

![medprompt](.gitbook/assets/medprompt.png)
...
![](.gitbook/assets/augmented-llm.png)
...
![](.gitbook/assets/workflow-prompt-chaining.png)
...
![](.gitbook/assets/workflow-routing.png)
...
![](.gitbook/assets/workflow-parallelization.png)
...
![](.gitbook/assets/workflow-orchestrator-workers.png)
...
![](.gitbook/assets/workflow-evaluator-optimizer.png)

#### Agents

\*\* 当LLM在理解复杂输入、推理规划、可靠使用工具和从错误中恢复等关键能力上成熟时，智能体可以处理开放式问题，无需预先定义步骤，并能根据环境反馈**自主决策**。在特定节点或遇到困难时暂停的功能，以便引入人工干预或反馈。

![](.gitbook/assets/auto-agents.png)

### google ai agents白皮书

[https://github.com/daiwk/collections/blob/master/assets/google-ai-agents-whitepaper.pdf](../assets/google-ai-agents-whitepaper.pdf)
...
![](.gitbook/assets/kimi-researcher-agent-rl-infra.png)
...
![](.gitbook/assets/tongyi-deepresearch-action-synthesis.png)
...
![](.gitbook/assets/deep-research-tool.png)

Universal Deep Research，输入有strategy和prompt

![](.gitbook/assets/udr.png)
