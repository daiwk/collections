...
![](<.gitbook/assets/agent-memory (1).png>)
...
![](<.gitbook/assets/agent-tool (1).png>)
...
![](<.gitbook/assets/agent-effecient-planning (1).png>)
...
* vllm：[https://docs.vllm.ai/en/stable/features/tool\_calling.html](https://docs.vllm.ai/en/stable/features/tool_calling.html)
...
这里的1、2是手动调用openai的接口，拿到模型返回结果时，从里面解析出来的要传给tool的参数，然后3需要我们自己本地调用具体函数，拿到结果再转成特定格式(加一个role为tool的content)，再去调用openai的接口拿到最终结果。整个过程可以看[https://github.com/daiwk/coding/blob/main/agentic/func\_calling.py](https://github.com/daiwk/coding/blob/main/agentic/func_calling.py)
...
![](<.gitbook/assets/tool_call_code1 (1).jpg>)

然后这个东西基于的是openai.BaseModel(transformers里最终也是走到这里)

![](<.gitbook/assets/tool_call_code2 (1).jpg>)

然后去openai里看

![](<.gitbook/assets/tool_call_code3 (1).jpg>)
...
![self-generated-cot-template](<.gitbook/assets/self-generated-cot-template (1).png>)

![medprompt](<.gitbook/assets/medprompt (1).png>)
...
![](<.gitbook/assets/augmented-llm (1).png>)
...
![](<.gitbook/assets/workflow-prompt-chaining (1).png>)
...
![](<.gitbook/assets/workflow-routing (1).png>)
...
![](<.gitbook/assets/workflow-parallelization (1).png>)
...
![](<.gitbook/assets/workflow-orchestrator-workers (1).png>)
...
![](<.gitbook/assets/kimi-researcher-agent-rl-infra (1).png>)
...
![](<.gitbook/assets/tongyi-deepresearch-action-synthesis (1).png>)
...
![](<.gitbook/assets/deep-research-tool (1).png>)

Universal Deep Research，输入有strategy和prompt

![](<.gitbook/assets/udr (1).png>)

### HyperAgents

[HyperAgents](https://arxiv.org/pdf/2603.19461)

meta的开源库，[https://github.com/facebookresearch/Hyperagents](https://github.com/facebookresearch/Hyperagents)
...
[https://verl.readthedocs.io/en/latest/start/agentic\_rl.html](https://verl.readthedocs.io/en/latest/start/agentic_rl.html)
...
![](<.gitbook/assets/agentic-rl-loop (1).png>)
...
![](<.gitbook/assets/spec-coding (1).png>)
...
[黄仁勋：Prompt正在过时，Loop才是新范式](https://mp.weixin.qq.com/s/A5OXrljqsxPZDPlQP3FAaA)

## openclaw项目管理

[https://github.com/daiwk/agent-teamwork](https://github.com/daiwk/agent-teamwork)
...
[https://pi.dev/docs/latest/providers](https://pi.dev/docs/latest/providers)
