...
[AI models collapse when trained on recursively generated data](https://www.nature.com/articles/s41586-024-07566-y)，对应下载的[pdf](../assets/nature-ai-train-ai.pdf)
...
![](.gitbook/assets/test-time-scaling.PNG)
...
[DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning](https://github.com/deepseek-ai/DeepSeek-R1/blob/main/DeepSeek_R1.pdf)，自己转存了一份：[pdf](../assets/DeepSeek_R1.pdf)
...
![](.gitbook/assets/grpo-advantage-token.png)
...
![](.gitbook/assets/ppo-grpo-deepseek-math.png)

形象的理解：

![](.gitbook/assets/ppo-grpo.png)
...
![](.gitbook/assets/r1-zero-performance.png)
...
![](.gitbook/assets/r1-zero-aha.png)
...
![](.gitbook/assets/deepseek-r1-flow.png)
...
[Kimi k1.5: Scaling Reinforcement Learning with LLMs](https://github.com/MoonshotAI/Kimi-k1.5/blob/main/Kimi_k1.5.pdf)，自己转存了一份：[pdf](../assets/Kimi_k1.5.pdf)
...
[https://github.com/THUDM/GLM-4/blob/main/README\_zh.md](https://github.com/THUDM/GLM-4/blob/main/README_zh.md)
...
[https://github.com/yfzhang114/r1\_reward](https://github.com/yfzhang114/r1_reward)
...
[https://github.com/RUCAIBox/Slow\_Thinking\_with\_LLMs](https://github.com/RUCAIBox/Slow_Thinking_with_LLMs)
...
[用动作分块突破RL极限，伯克利引入模仿学习，超越离线/在线SOTA](https://mp.weixin.qq.com/s/y_g6Buw0DEzW0gXVOqYPdg)

[Reinforcement Learning with Action Chunking](https://arxiv.org/abs/2507.07969)

[https://github.com/ColinQiyangLi/qc](https://github.com/ColinQiyangLi/qc)
...
Q-chunking将模仿学习中的动作分块（action chunking）引入到基于时序差分（Temporal Difference, TD）的强化学习中。
...
从源码安装参考[https://docs.vllm.ai/en/latest/getting\_started/installation/gpu/index.html#build-wheel-from-source](https://docs.vllm.ai/en/latest/getting_started/installation/gpu/index.html#build-wheel-from-source)
...
* 去[https://huggingface.co/unsloth/DeepSeek-R1-GGUF/tree/main](https://huggingface.co/unsloth/DeepSeek-R1-GGUF/tree/main)把config.json下载下来，把json里的torch\_dtype里的bfloat16改成float16，覆盖掉上面那个目录里的config.json
...
* 数据：[https://github.com/hpcaitech/ColossalAI/blob/main/applications/ColossalChat/examples/training\_scripts/lora\_sft\_data.jsonl](https://github.com/hpcaitech/ColossalAI/blob/main/applications/ColossalChat/examples/training_scripts/lora_sft_data.jsonl)
* fp8权重转bf16：[https://github.com/deepseek-ai/DeepSeek-V3/blob/main/inference/fp8\_cast\_bf16.py](https://github.com/deepseek-ai/DeepSeek-V3/blob/main/inference/fp8_cast_bf16.py)
* 脚本：[https://github.com/hpcaitech/ColossalAI/blob/main/applications/ColossalChat/examples/training\_scripts/lora\_finetune.py](https://github.com/hpcaitech/ColossalAI/blob/main/applications/ColossalChat/examples/training_scripts/lora_finetune.py)

通过使用 LoRA 等优化，示例命令已将 SFT DeepSeek V3/R1 671B 最低硬件要求降低近 10 倍，可使用 32 个 Ascend 910B NPU 64GB（使用 ep=8,pp=4）或 24 个 H100/H800 GPU（使用 ep=8,pp=3）。如果你通过 --zero\_cpu\_offload 启用 CPU offload，硬件要求可以进一步降低，但会损失一定的训练速度。
...
* 模板和设定：[https://github.com/hpcaitech/ColossalAI/blob/main/applications/ColossalChat/conversation\_template/Qwen\_Qwen2.5-3B.json](https://github.com/hpcaitech/ColossalAI/blob/main/applications/ColossalChat/conversation_template/Qwen_Qwen2.5-3B.json)
* 启动脚本：[https://github.com/hpcaitech/ColossalAI/blob/main/applications/ColossalChat/examples/training\_scripts/train\_grpo.sh](https://github.com/hpcaitech/ColossalAI/blob/main/applications/ColossalChat/examples/training_scripts/train_grpo.sh)
...
[Seed Research｜4B 模型数学推理接近 235B 表现，Seed 最新强化学习配方全面开源](https://mp.weixin.qq.com/s/6ohGURiGs9z-Osh_Ew7Grw)
...
![](.gitbook/assets/post-training-reason-economy.png)
...
![](.gitbook/assets/test-time-reason-economy.png)
...
![](.gitbook/assets/efficient-cot.png)
...
例如[跟着台大李宏毅老师学：别让推理模型想太多](https://mp.weixin.qq.com/s/dXxuRN311-c6CN4zOl8lFg)里提到的[L1: Controlling How Long A Reasoning Model Thinks With Reinforcement Learning](https://arxiv.org/pdf/2503.04697)
...
[AGI前夜重磅：RL突破模型「认知上限」，真·学习发生了！](https://mp.weixin.qq.com/s/0yk3VEJrpXWTTnR15bB4Qg)

### Training free-GRPO

[X上63万人围观的Traning-Free GRPO：把GRPO搬进上下文空间学习](https://mp.weixin.qq.com/s/mzww1pKILFSFqRA8aui0fA)

[Training-Free Group Relative Policy Optimization](https://arxiv.org/abs/2510.08191)

[https://github.com/TencentCloudADP/youtu-agent/tree/training\_free\_GRPO](https://github.com/TencentCloudADP/youtu-agent/tree/training_free_GRPO)

### R-HORIZON

[R-HORIZON：长程推理时代来临，复旦NLP&美团LongCat重磅发布LRMs能力边界探测新范式](https://mp.weixin.qq.com/s/d7sPy0hCnOu9usRFtiAepg)

[R-HORIZON: How Far Can Your Large Reasoning Model Really Go in Breadth and Depth?](https://arxiv.org/abs/2510.08189)

[https://github.com/meituan-longcat/R-HORIZON](https://github.com/meituan-longcat/R-HORIZON)

### Reasoning with sampling

[不用强化学习也能推理，哈佛新采样算法竟能让基础模型比肩GRPO后训练版本](https://mp.weixin.qq.com/s/JbJI5aixLAt9hfcqrepZoQ)

[Reasoning with Sampling: Your Base Model is Smarter Than You Think](https://www.arxiv.org/pdf/2510.14901)

[https://github.com/aakaran/reasoning-with-sampling](https://github.com/aakaran/reasoning-with-sampling)

### DisCO

[NeurIPS25高分论文｜以判别式监督学习强化推理LLM，解决难度偏差和熵崩塌难题](https://mp.weixin.qq.com/s/gmvJx4C_OaVvA-0zm_vbyg)

[DisCO: Reinforcing Large Reasoning Models with Discriminative Constrained Optimization](https://arxiv.org/abs/2505.12366)

[https://github.com/Optimization-AI/DisCO](https://github.com/Optimization-AI/DisCO)

## 推理模型总结

[从自我进化视角出发，全面解析LLM的推理能力技术演进路径](https://mp.weixin.qq.com/s/hkYW0c26eLEHE9WgIQxwHw)

[A Survey on LLM Complex Reasoning through the Lens of Self-Evolution](../assets/Survey_of_LLM_Reaoning_by_Self_Evolution.pdf)
...
![](.gitbook/assets/compute-power-law.png)
